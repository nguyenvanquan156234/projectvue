<template >
    <div class="admin">
      <div class="page-wrapper default-theme sidebar-bg bg1" :class="{ 'toggled': menuToggled }">
          ...
          <div class="sidebar-content">
            ...
            <div class="sidebar-item sidebar-header">
              ...
              <div class="user-info">
                ...
                <span class="user-role">{{ emailuser }}</span>
            ...
            <div class="sidebar-item sidebar-menu">
              <ul>
                ...
                <li>
                  <router-link to="/admin/thongkedonhang">
  ...
  export default {
    ...
    data() {
      return {
        ...
        name: null,
        email: null,
        menuToggled: false // Add a boolean data property to control the class toggling
      };
    },
    created() {
    const auth = getAuth();
    onAuthStateChanged(auth, (user) => {
      if (user) {
        // Nếu có người dùng đăng nhập, gán email của họ cho biến email
        this.emailuser = user.email;
      } else {
        // Nếu không có người dùng đăng nhập, gán giá trị null cho biến email
        this.emailuser = null;
      }
    })
  },
    methods: {
      closeMenu() {
        // Toggle a boolean data property to control the class
